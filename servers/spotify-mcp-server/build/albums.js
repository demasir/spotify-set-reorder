        ...
        try {
            ...
            return {
                content: [
                    {
                        type: 'text',
                        text: `Error getting albums: ${error instanceof Error ? error.message : String(error)}`,
                    },
                ],
            };
        }
    ...
    handler: async (args, _extra) => {
        ...
        try {
            const tracks = await handleSpotifyRequest(async (spotifyApi) => {
                return await spotifyApi.albums.tracks(albumId, undefined, limit, offset);
            });
            ...
            return {
                content: [
                    {
                        type: 'text',
                        text: `Error getting album tracks: ${error instanceof Error ? error.message : String(error)}`,
                    },
                ],
            };
        }
        ...
        try {
            ...
            return {
                content: [
                    {
                        type: 'text',
                        text: `Error ${action === 'save' ? 'saving' : 'removing'} albums: ${error instanceof Error ? error.message : String(error)}`,
                    },
                ],
            };
        }
        ...
        try {
            ...
            return {
                content: [
                    {
                        type: 'text',
                        text: `Error checking saved albums: ${error instanceof Error ? error.message : String(error)}`,
                    },
                ],
            };
        }
